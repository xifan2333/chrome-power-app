    ...
    resources: {
      en: {
        translation: {
          ...
          sync_column_id: 'ID',
          sync_column_name: 'Name',
          sync_column_group: 'Group',
          sync_column_tags: 'Tags',
          sync_btn_tile: 'Tile Windows',
          sync_msg_tile_windows_success: 'Windows have been tiled',
          sync_btn_control: 'Sync Control',
          sync_operation_section: 'Operation Section',
          sync_text_manager: 'Text Manager',
          sync_label_text_same: 'Same Text',
          sync_label_text_specified: 'Specified Text',
          sync_radio_text_random: 'Random',
          sync_radio_text_order: 'Order',
          sync_btn_text_simulate: 'Simulate Input',
          sync_tab_manager: 'Tab Manager',
          sync_label_open_url: 'Open URL',
          sync_placeholder_open_url: 'Enter the URL, one per line e.g.&#10;https://www.baidu.com&#10;https://www.google.com',
          sync_radio_open_url: 'First URL in current tab',
          sync_btn_open_url: 'Open',
      ...
      zh: {
        translation: {
          ...
          sync_column_check: '选择',
          sync_column_id: 'ID',
          sync_column_name: '名称',
          sync_column_group: '分组',
          sync_column_tags: '标签',
          sync_btn_tile: '平铺窗口',
          sync_msg_tile_windows_success: '窗口已平铺',
          sync_btn_control: '同步控制',
          sync_operation_section: '操作台',
          sync_text_manager: '文本管理',
          sync_label_text_same: '相同文本',
          sync_label_text_specified: '指定文本',
          sync_radio_text_random: '随机输入',
          sync_radio_text_order: '顺序输入',
          sync_btn_text_simulate: '仿真输入',
          sync_tab_manager: '标签管理',
          sync_label_open_url: '打开网址',
          sync_placeholder_open_url: '请输入网址，每行一个例如:\nhttps://www.baidu.com\nhttps://www.google.com',
          sync_radio_open_url: '首个网址在当前标签页打开',
          sync_btn_open_url: '打开',
        },
      },
    },
    fallbackLng: 'zh',
